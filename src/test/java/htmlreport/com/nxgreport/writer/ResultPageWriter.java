...
public class ResultPageWriter {
    ...
    public static void printContent(PrintWriter printWriter, List<ITestResult> passedTests, List<ITestResult> failedTests, List<ITestResult> skippedTests, long startTime, long endTime) {
