...
//	 */
    ...
    public void verifyAdminGiveAditorAccess() throws Exception {
        ...
        String strAdminEmail = GenericService.getUserFromExcelData("EmailTemplateData", "Valid User", "Admin");
        String strAdminPwd = GenericService.getUserFromExcelData("EmailTemplateData", "Valid User", "PasswordAdmin");
        try {
