...
//        String clientFullName = "Thuan Client";*/
    ...
    public void verifyAddNewRequestOnToDoPage(String auditorId, String auditorPwd, String engagementName,
                                              String pathOfUploadLocation, String fileName, String toDoName,
                                              String deadlineDate, String endDate, String startDate,
                                              String request01Value, String request02Value,
        ...
        try {
            ...
            auditorCreateToDoService.createNewRequest(request01Value,position01Value);
            auditorCreateToDoService.verifyColorAddRequestBtn();
            auditorCreateToDoService.verifyClickAddRequestBtn();
            auditorCreateToDoService.createNewRequest(request02Value,position02Value);
            // temporary return Engagement to verify newRequest.
            auditorCreateToDoService.reselectEngagementName(engagementName);
            auditorCreateToDoService.verifyColorAddRequestBtn();
            auditorCreateToDoService.uploadeNewFileByRequestName(pathOfUploadLocation, fileName,request01Value);
            auditorCreateToDoService.verifyColorAddRequestBtn();
    ...
    public void verifyClientUploadOnRequest(String clientId, String clientPwd, String engagementName,
                                            String pathOfUploadLocation, String fileName,String requestValue) throws Exception {
        auditorCreateToDoService = new AuditorCreateToDoService(getLogger(), getDriver());
        auditorEngagementService = new AuditorEngagementService(getLogger(), getDriver());
        auditorDetailsEngagementService = new AuditorDetailsEngagementService(getLogger(), getDriver());
        auditorTodoListService = new AuditorTodoListService(getLogger(), getDriver());
        ...
        try {
            ...
            auditorEngagementService.viewEngagementDetailsPage(engagementName);
            auditorCreateToDoService.verifyColorAddRequestBtn();
            auditorCreateToDoService.uploadeNewFileByRequestName(pathOfUploadLocation, fileName,requestValue);
            auditorCreateToDoService.verifyColorAddRequestBtn();
            auditorCreateToDoService.verifyUploadFileSuccessfully(fileName);
            Assert.assertTrue(AbstractService.sStatusCnt == 0, "Script Failed");
    ...
    public void verifyAuditorDownloadOnRequest(String auditorId, String auditorPwd, String engagementName,
                                               String pathOfUploadLocation, String fileName, String pathOfDownloadLocation) throws Exception {
        auditorCreateToDoService = new AuditorCreateToDoService(getLogger(), getDriver());
        auditorEngagementService = new AuditorEngagementService(getLogger(), getDriver());
        auditorDetailsEngagementService = new AuditorDetailsEngagementService(getLogger(), getDriver());
        auditorTodoListService = new AuditorTodoListService(getLogger(), getDriver());
...
//        String toDoName = "TestAssignToDoBulk01";*/
    ...
    public void verifyDeleteSingleAndMultipleToDo(String auditorId, String auditorPwd,
                                                  String engagementName, String toDoNameDeleteSingle,
