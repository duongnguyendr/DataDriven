 ...
 */
public class ClientTestOld extends AbstractTest {
    ...
    *//*
    ...
    public void verifyInvitationEmail() throws Exception {
        ...
        try {
            ...
            gmailLoginService.verifyAuvenirIntroducingTitle(
            ...
            gmailLoginService.verifySecondBenefitTitle(
            ...
            gmailLoginService.verifyFeedbackTitle(
                    "We welcome your feedback, ideas and suggestions to make the audit experience better. Send us an email at feedback@auvenir.com.");
    ...
    public void verifyClientOnboardingPage() throws Exception {
        ...
        try {
            ...
            NXGReports.addStep("Testscript Failed: Verify Client Onboarding Page", LogAs.FAILED,
    ...
    public void verifyCLientActiveEmail() throws Exception {
        ...
        try {
			...
			*/
            ...
            NXGReports.addStep("Testscript Failed: Verify CLient Active Email", LogAs.FAILED,
                               new CaptureScreen(CaptureScreen.ScreenshotOf.BROWSER_PAGE));
            throw e;
        } catch (Exception e) {
            NXGReports.addStep("Testscript Failed: Verify CLient Active Email", LogAs.FAILED,
    ...
    public void verifyClientDashboardPage() throws Exception {
        ...
        try {
            ...
            NXGReports.addStep("Testscript Failed: Verify the display of Elements in Client Dashboard Page", LogAs.FAILED,
                               new CaptureScreen(CaptureScreen.ScreenshotOf.BROWSER_PAGE));
            throw e;
        } catch (Exception e) {
            NXGReports.addStep("Testscript Failed: Verify the display of Elements in Client Dashboard Page", LogAs.FAILED,
    ...
    public void verifyClientHomePage() throws Exception {
        ...
        try {
            ...
            NXGReports.addStep("Testscript Failed: Verify the display of Elements in Client Home Page.", LogAs.FAILED,
                               new CaptureScreen(CaptureScreen.ScreenshotOf.BROWSER_PAGE));
            throw e;
        } catch (Exception e) {
            NXGReports.addStep("Testscript Failed: Verify the display of Elements in Client Home Page.", LogAs.FAILED,
    ...
    public void verifyClientRequestPage() throws Exception {
        ...
        try {
            ...
            NXGReports.addStep("Testscript Failed: Verify the display of Elements in Client Request Page", LogAs.FAILED,
                               new CaptureScreen(CaptureScreen.ScreenshotOf.BROWSER_PAGE));
            throw e;
        } catch (Exception e) {
            NXGReports.addStep("Testscript Failed: Verify the display of Elements in Client Request Page", LogAs.FAILED,
    ...
    public void verifyClientFilesPage() throws Exception {
        ...
        try {
            ...
            NXGReports.addStep("Testscript Failed: Verify the display of Elements in Client Files Page", LogAs.FAILED,
                               new CaptureScreen(CaptureScreen.ScreenshotOf.BROWSER_PAGE));
            throw e;
        } catch (Exception e) {
            NXGReports.addStep("Testscript Failed: Verify the display of Elements in Client Files Page", LogAs.FAILED,
