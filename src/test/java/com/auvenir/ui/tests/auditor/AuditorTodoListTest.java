...
public class AuditorTodoListTest extends AbstractTest {
    ...
    public void verifyAuditorEmptyTodoListPage() throws Exception {
        ...
        try {
            ...
            auditorNewEngagementService.enterDataForNewEngagementPage("engagement" + GeneralUtilities.getTimeStampForNameSuffix(), "type" + GeneralUtilities.getTimeStampForNameSuffix(), "company" + GeneralUtilities.getTimeStampForNameSuffix());
