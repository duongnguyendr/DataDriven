...
//        MongoDBService.removeEngagementObjectByName(MongoDBService.getCollection("engagements"), engagementName);
    ...
    public void verifyAddNewRequestOnToDoPage() throws Exception {
        ...
        try {
            maketingService.goToAuvenirMarketingPageURL();
            maketingService.selectLoginBtn();
    ...
    public void verifyAuditorDownloadOnRequest() throws Exception {
        ...
        try {
            ...
            auditorEngagementService.viewEngagementDetailsPage(engagementName);
            auditorCreateToDoService.verifyColorAddRequestBtn();
            auditorCreateToDoService.auditorDownloadNewRequestFile(pathFileUpload,pathFileDownload, fileName);
            Assert.assertTrue(AbstractService.sStatusCnt == 0, "Script Failed");
...
//        String toDoName = "TestAssignToDoBulk01";
    ...
    public void verifyClientDownloadAttachFile() throws Exception {
        ...
        try {
            ...
            NXGReports.addStep("Verify client download attach file.", LogAs.FAILED,
                    new CaptureScreen(CaptureScreen.ScreenshotOf.BROWSER_PAGE));
            getLogger().info(e);
            throw e;
        }
