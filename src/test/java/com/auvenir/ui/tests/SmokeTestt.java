...
public class SmokeTestt extends AbstractTest {
    ...
    public void verifyAuditorInvitingTheClient() {
        ...
        try {
            ...
            adminId = GenericService.getTestDataFromExcel("SmokeTest", "Valid User", "Admin");
            auditorId = GenericService.getTestDataFromExcel("SmokeTest", "Valid User4", "Auditor");
            adminId = adminId.replace("chr.", "");
            auditorId = auditorId.replace("chr.", "");
...
//            adminService.verifyUserStatusOnAdminUserTable(clientId, "Pending");
    ...
    public void verifyCreateTodoPage() throws Exception {
        ...
        try {
            String userId = GenericService.getTestDataFromExcel("SmokeTest", "Valid User4", "Auditor");
...
//            String userId = GenericService.getTestDataFromExcel("SmokeTest", "Valid User", "Auditor");
     ...
     * On-going
     */
    @Test(priority = 17, enabled = false, description = "Client verify engagement, assigned To-Do , file uploaded by auditor, auditor's comment")
