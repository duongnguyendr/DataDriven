 ...
 */
public class MailAuditorInviteClientPO extends BaseMailTemplatePO {
    ...
    // Element of button started Engagement
    @FindBy(xpath = "//center/table[1]/tbody/tr/td/p/a[@href='http://auvenir.s3corp.com.vn:5000']")
    private WebElement btnStartEngagement;
    public WebElement getBtnStartEngagement(){return btnStartEngagement; }
    ...
    public MailAuditorInviteClientPO(WebDriver driver) {
        super(driver);
    ...
    public void verifyPageContent() {
        ...
        // Checking button Start Engagement Auvenir
        NXGReports.addStep("Verify button Start Engagement Auvenir", LogAs.PASSED, null);
        this.validateElememt(btnStartEngagement,"Element of button Start Engagement Auvenir", Element_Type.DISPLAYED);
