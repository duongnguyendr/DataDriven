...
public class AbstractPage {
    ...
    @FindBy(xpath = "//div[starts-with(@id,'categoryModel') and contains(@style,'display: block')]//button [starts-with(@id,'m-ce-cancelBtn')]")
...
//    WebElement eleEditCategoryCloseBtn;
    ...
    public boolean verifyCategoryNameMaxLength() {
        ...
        try {
            isCheckMaxLength = validateMaxlenght(categoryNameFieldOnFormEle, "Category Name TextBox", maxLenght);
            if (isCheckMaxLength) {
